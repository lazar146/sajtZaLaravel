...
<!-- Vendor JS -->
<script src="{{ asset('adminAssets/vendor/slick/slick.min.js') }}"></script>
...
<script src="{{ asset('adminAssets/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js') }}"></script>
<script src="{{ asset('adminAssets/vendor/counter-up/jquery.waypoints.min.js') }}"></script>
<script src="{{ asset('adminAssets/vendor/counter-up/jquery.counterup.min.js') }}"></script>
...
<script src="{{ asset('adminAssets/vendor/select2/select2.min.js') }}"></script>
