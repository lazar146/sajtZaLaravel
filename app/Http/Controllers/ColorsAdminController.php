...
class ColorsAdminController extends Controller
{
    /**
    ...
    {
        $isNew = true;
        return view('admin.forms.colorsForm',['isNew'=>$isNew,'tableName'=>'colors']);
    }
    ...
    {
        $content = ColorModel::find($id);
        $isNew = false;
        return view('admin.forms.colorsForm',['content'=>$content,'isNew'=>$isNew]);
    }
